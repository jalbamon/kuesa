...
{
    using WeightGetterFunc = float (MorphController::*)() const;
    const WeightGetterFunc weightGetterFuncs[]{
        &MorphController::weight0,
        &MorphController::weight1,
        &MorphController::weight2,
        &MorphController::weight3,
        &MorphController::weight4,
        &MorphController::weight5,
        &MorphController::weight6,
        &MorphController::weight7
    };
    ...
    for (int i = 0; i < m_count; ++i)
        weights.push_back((this->*weightGetterFuncs[i])());
